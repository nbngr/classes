 ...
 * @link https://github.com/nbngr/ftp/
...
class Ftp
{
	...
	public function change_dir($path = '')
	{
		...
		if ($result === false) {
			if ($this->_debug == true) {
				throw new \Exception('Unable to change the directory');
			}
			return false;
		}
	...
	public function chmod($path, $permissions)
	{
		...
		if (!function_exists('ftp_chmod')) {
			if ($this->_debug == true) {
				throw new \Exception('CHMOD function does not exist');
			}
			return false;
		}
